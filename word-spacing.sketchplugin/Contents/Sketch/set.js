...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/set.js");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  if (selectedCount == 0) {
    ...
    var wordSpacing = sketch__WEBPACK_IMPORTED_MODULE_0___default.a.UI.getStringFromUser('Word spacing in px', 4);
    ...
    for (var i = 0; i < selectedCount; i++) {
      ...
      if (layerType == 'MSTextLayer') {
        sketch__WEBPACK_IMPORTED_MODULE_0___default.a.UI.message("kerning: ".concat(selectedLayers.layers[0].style.kerning));
        var textValue = layer.stringValue();
        var ranges = getRanges(textValue, ' ');

        if (ranges.length < 1) {
          sketch__WEBPACK_IMPORTED_MODULE_0___default.a.UI.message('Error: No matching text found 😢');
          return false;
        }
